...
class OrderServiceTest {
    ...
    public void orderItemTest() throws Exception {
        ...
        // when
        int orderCount = 2;
        Long ordered = orderService.order(member.getId(), book.getId(), orderCount);

        // then
        Order getOrder = orderRepository.findOne(ordered);
    ...
    @Test
    public void itemStockTest() throws Exception {
        // given
        Member member = createMember();
        Item book = createBook("JPA test", 10000, 10);
    ...
    private Member createMember() {
        ...
        member.setAddress(new Address("seoul", "west", "123-123"));
        em.persist(member);
        return member;
    }
